    ...
    <div class="row">
      <div class="col-md-8">
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form  id="formaddproduct" class="needs-validation form-horizontal" novalidate role="form" action="{{URL::to('/submit-add-category')}}"
             ...
             data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" enctype="multipart/form-data">
                ...
                <div class="box-footer row">
                    <button type="submit" class="ml-5 col-3 btn btn-primary ">Thêm Danh mục</button>
                </div>
              </form>
          </div>
          <!-- /.box-body -->
