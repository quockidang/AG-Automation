            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="pl-3" href="{{URL::to('/show-cart-admin-now/')}}"><button
                    ...
                    <div class="box-body">
                        <div class=" table-borderless">
                            ...
                            <input style="width: 20%" class="form-control mr-sm-2" name="search" id="search_kit_now"
                            ...
                            <table class="table table-sm table-hover table-borderless table-striped b-t b-light">
                                ...
                                <tbody id="all_kit">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <form action="{{URL::to('add-kit-cart-admin-now/'.$product->id)}}"
                                                method="post">
                                                {{ csrf_field() }}
                                                <?php
                        ...
                        <div class=" table-borderless">
                            ...
                            <input style="width: 20%" class="form-control mr-sm-2" name="search" id="search_product_now"
                        ...
                        <div class=" table-borderless">
                            ...
                            <input style="width: 20%" class="form-control mr-sm-2" name="search" id="search_accessories_now"
...
<script>
    $('#search_kit_now').on('keyup',function(){
            $value = $(this).val();
            $idCustomer = $('.idCustomer').val();
            $.ajax({
                type: 'get',
                url: '{{ URL::to('search-kit-now') }}',
                data: {
                    'search': $value,
...
<script>
    $('#search_product_now').on('keyup',function(){
                $value = $(this).val();
                $idCustomer = $('.idCustomer').val();
                $.ajax({
                    type: 'get',
                    url: '{{ URL::to('search-product-now') }}',
                    data: {
                        'search': $value,
                        'idCustomer': $idCustomer
                    },
...
<script>
    $('#search_accessories_now').on('keyup',function(){
                    $value = $(this).val();
                    $idCustomer = $('.idCustomer').val();
                    $.ajax({
                        type: 'get',
                        url: '{{ URL::to('search-accessories-now') }}',
                        data: {
                            'search': $value,
                            'idCustomer': $idCustomer
                        },
