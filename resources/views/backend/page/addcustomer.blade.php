    ...
    <div class="row">
      <div class="col-md-8">
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form  id="formaddproduct" class="needs-validation form-horizontal" novalidate role="form" action="{{URL::to('/submit-add-customer')}}"
             ...
             data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class=" form-group ">
                                <input type="email" minlength="10" maxlength="100"
                                data-bv-stringlength-message="Vui lòng nhập chuỗi có độ dài lớn hơn 10 và nhỏ hơn 100"
