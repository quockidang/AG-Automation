    ...
    <div class="row">
      <div class="col-md-8">
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form  id="formaddproduct" class="needs-validation form-horizontal" novalidate role="form" action="{{URL::to('/submit-add-accessory')}}"
             ...
             data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group ">
                                ...
                                name="meta_desc" required data-error="Vui lòng nhập detail" class="form-control form-control-sm"  placeholder="Mô tả ngắn"></textarea>
                                <div class="invalid-feedback">
                                    Vui lòng nhập thông tin phụ kiện
                                </div>
                        </div>
                ...
                <div class="box-footer row">
                    ...
                    <button type="submit" class="ml-5 col-3 btn btn-outline-primary ">Thêm Phụ Kiện</button>
                </div>
              </form>
          </div>
          <!-- /.box-body -->
