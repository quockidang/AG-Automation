                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_vn_edit">
                            <form class="form-horizontal" id="LevelForm" role="form" data-toggle="validator">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-label">Năm sinh</label>
                                    <div class="col-sm-9">
                                        <input ype="text" class="form-control" id="addNgay" name="addNgay" value="">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input required type="text" class="form-control" id="addDienThoai"
                                            name="addDienThoai" value=""
                                            data-required-error="Điện thoại không được trống." minlength="6"
                                            data-minlength-error="Độ dài ngắn nhất 10">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input required type="text" class="form-control" id="addDiaChi" name="addDiaChi"
                                            value="" data-required-error="Địa chỉ không được trống.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
